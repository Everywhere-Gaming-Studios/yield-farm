...
contract TicketVault is Ownable, Pausable {
    ...
    IERC20 public immutable token; // Ticket token
    ...
    /**
     * @notice Constructor
     * @param _token: Ticket token contract
     * @param _receiptToken: Receipt token contract
     * @param _masterchef: MasterTicket contract
    ...
    /**
     * @notice Deposits funds into the Ticket Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in TICKET)
     */
    ...
    /**
     * @notice Reinvests TICKET tokens into MasterTicket
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraws from MasterTicket to Vault without caring about rewards.
     ...
     * @return Expected reward to collect in TICKET
     */
    ...
    /**
     * @notice Withdraws from funds from the Ticket Vault
    ...
    /**
     * @notice Deposits tokens into MasterTicket to earn staking rewards
     */
